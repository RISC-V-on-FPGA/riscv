...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { flash }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
...
##USB-RS232 Interface
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { uart_serial }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
